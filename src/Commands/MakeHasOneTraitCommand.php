...
#[AsCommand(name: 'make:relation:has-one')]
class MakeHasOneTraitCommand extends GeneratorCommand
{
    ...
    {
        return 'HasOne'.$this->getRawNameInput();
    }
    ...
    {
        return __DIR__.'/stubs/HasOneTrait.stub';
    }
